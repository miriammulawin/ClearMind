  ...
  const filteredDoctors = activeSpecialist
    ? MOCK_DOCTORS.filter(d =>
        d.title.toLowerCase().includes(
          SPECIALIST_INFO[activeSpecialist].role.toLowerCase()
        )
      )
    : MOCK_DOCTORS;
    ...
    <Container className={`${styles.bookAppointmentContainer} py-4`}>
      ...
      <div className={styles.titleContainerBook}>
        ...
        <Button
          ...
          onClick={() => selectedDoctor ? handleBackToDoctors() : navigate(-1)}
        >
          <FaArrowLeft /> Go Back
        </Button>
      </div>
      ...
      {!selectedDoctor ? (
        <>
          ...
          >
            🤔 Not sure which specialist to choose?{' '}<span> Click here to learn more!</span>
          </p>
            ...
            <div className={styles.specialistToggle}>
              {Object.keys(SPECIALIST_INFO).map((key) => (
                <button
                  ...
                  onClick={() => setActiveSpecialist(prev => prev === key ? null : key)}
                >
                ...
                <div className={styles.modalBody}>
                  <div className={styles.modalCard}>
                    ...
                    <p className={styles.modalCardDesc}>
                      Best if you're dealing with stress, anxiety, trauma, relationship issues,
                      or just need someone to talk to. They help through therapy and assessments
                  ...
                  <div className={styles.modalCard}>
                    ...
                    <p className={styles.modalCardDesc}>
                      Best if you need a formal diagnosis, a mental health certificate
                      (for work/school/legal), or a psychiatric evaluation. They are medical
                      doctors who can assess more complex conditions.
                    </p>
                  </div>

                  <div className={styles.modalTip}>
                    💡 <strong>Not sure?</strong> Start with a Psychologist — they can refer
                    ...
                    <div className={styles.earliestSchedule}>
                      ...
                      <div className={styles.scheduleInfo}>
                        ...
                        <p className={styles.scheduleTime}>
                          ...
                          {doctor.availability[0]?.slots.find(s => s.available)?.time || 'N/A'}
                        </p>
                        <p className={styles.scheduleFee}>
                          Fee: ₱{doctor.consultationFees.initialConsultation.toLocaleString()}
                        </p>
                      </div>
                    </div>
