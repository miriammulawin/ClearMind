        ...
        <Card.Body >
          ...
          <Form>
            <Form.Group className="mb-2" controlId="email">
              <Form.Label className="login-text" >Email <span className="text-danger">*</span></Form.Label>
            ...
            {/* passoword */}
            <Form.Group className="mb-2" controlId="password" style={{ position: "relative" }}>
              <Form.Label className="login-text">Password <span className="text-danger">*</span></Form.Label>
                <div className="input-icon-wrapper">
