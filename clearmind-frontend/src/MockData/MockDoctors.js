...
export const MOCK_DOCTORS = [
  ...
  },
  {
    ...
    title: "Executive Director, Chief Psychologist",
    sex: "Female",
  ...
  {
    id: 9,
    name: "Erika Mae Faustino",
    sex: "Female",
    title: "Clinic Psychometrician",
    credentials: "RPm, CSPE,CHRA",
    avatar: null,
    consultationType: "On-Site Clinic (CMPS)",
    consultationMode: "Onsite",
    onSiteDays: ["Tuesday", "Thursday", "Saturday"],
