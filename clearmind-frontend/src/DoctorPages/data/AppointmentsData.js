...
const appointments = [
...

  {
    ...
    initialComplaint:  "Patient reports repeated physical and emotional abuse by live-in partner over the past 8 months. States she is afraid to leave due to threats against her children. Referred by barangay VAWC officer after neighbor report.",
    payment:           "Paid",
    rescheduledTo:     null,
...

  {
    ...
    initialComplaint:  "Patient is subject of a custody dispute. Court has requested full psychological evaluation to assess parenting capacity and child welfare. Referred by CSWD Case Worker Ms. Rivera.",
    payment:           "Paid",
    rescheduledTo:     null,
    assessmentSession: null,
  },
...

  {
    ...
    status:            "Confirmed",
    reason:            "Learning disability screening requested by school guidance counselor",
...

  {
    ...
    reason:            "Employee referred by HR due to persistent work-related stress, difficulty concentrating, and reported emotional breakdowns during work hours over the past month.",
    initialComplaint:  null,
    payment:           "Unpaid",
    rescheduledTo:     null,
    assessmentSession: null,
...

  {
    ...
    initialComplaint:  "Patient presents with signs of prolonged emotional and economic abuse by spouse. She reports being denied access to finances and being isolated from family for over a year.",
    payment:           "Unpaid",
    rescheduledTo: {
      date:      "2026-03-21",
      startTime: "10:00",
      endTime:   "11:00",
      reason:    "Patient requested a safer time to attend without spouse's knowledge",
    },
    assessmentSession: null,
  },
...

  {
    ...
    initialComplaint:  "Subject referred by PACO officer for mandatory psychological evaluation as part of parole conditions. Has completed 6 months of community service.",
    payment:           "Paid",
    rescheduledTo: {
      date:      "2026-03-25",
      startTime: "13:00",
...

  {
    ...
    assessmentPurpose: "School / Academic Support",
    status:            "Scheduled",
    reason:            "Discussion of results from initial psychological assessment (Session 2)",
    initialComplaint:  null,
    payment:           "Paid",
    rescheduledTo:     null,
    schoolDocuments:   [],
    ...
    assessmentSession: {
      ...
      sessionNotes:    "Psychologist will present and explain findings from Session 1 IQ and learning disability screening. Parent/guardian advised to attend.",
    },
  },
...

  {
    ...
    assessmentSession: {
      ...
      sessionNotes:    "Official psychological assessment certificate and written report will be released to the patient or authorized representative. Valid government-issued ID required upon release.",
    },
  },
