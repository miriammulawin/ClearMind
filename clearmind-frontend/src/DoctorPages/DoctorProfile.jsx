...
function DoctorProfile() {
  const [activeMenu, setActiveMenu] = useState("Personal Information"); // ✅ default menu
                ...
                >
                  ...
                  >
                    <div className="card-body text-center">
                      ...
                      <h5 className="fw-bold mb-1" style={{ color: "#4D227C" }}>
                        {doctorData.name}
                      </h5>
                      <p
                  ...
                  >
                    <div className="card-body py-3 d-flex flex-column">
                      <small className="text-muted fw-semibold mb-3">
                        MENU
                      </small>
                        ...
                        <div className="row mt-5">
                          <div className="col-sm-6 mb-3 mb-sm-0">
                            <div className="border-end pe-3">
                              <small
                                className="text-muted d-block mb-1 fw-semibold"
                                style={{ color: "#4D227C" }}
                              >
                                MAIN SPECIALTY
                              </small>
                        ...
                        <div className="card-body p-4">
                          ...
                          <div className="row mb-4">
                            <div className="col-md-6 mb-3 mb-md-0">
                              <label
                                className="form-label small mb-2 fw-semibold"
                                style={{ color: "#4D227C" }}
                              >
                                SUBSPECIALTY
                              </label>
