          ...
          >
            ...
            >
              ...
              <div className={styles.modalList}>
                {allUsers.length === 0 ? (
                  <p className={styles.modalEmpty}>No users available.</p>
                ) : (
                  allUsers.map((u) => (
                    <div
                      key={u.id}
                          ...
                          <div key={m.id}>
                            ...
                            >
                              ...
                              <div className={styles.bubbleCol}>
                                ...
                                {/* Action bar — edit / unsend */}
                                {isMine &&
                                  !m.unsent &&
                                  !isEditing &&
                                  hoveredMsg === m.id && (
                                    <div
                                      className={`${styles.actionBar} ${isMine ? styles.actionBarMine : ""}`}
                                    >
                                      {m.body && (
                                        <button
