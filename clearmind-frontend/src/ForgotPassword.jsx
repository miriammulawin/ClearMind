...
function ForgotPassword() {
  ...
  /* ── STEP 2: OTP input handling (UI only — submitted in step 3) ── */
  ...
  // Proceed from OTP screen to password screen
  const handleOtpNext = (e) => {
    e.preventDefault();
    setError("");
    if (otp.join("").length < 6)
      return showError("Please enter the complete 6-digit code.");
    setStep(3);
  };
  ...
  /* ── STEP 3: Submit OTP + new password together ── */
  ...
  const stepMeta = {
    ...
    3: {
      ...
      subtitle: "Your new password must meet the requirements below.",
    },
    4: {
      ...
      <div className={styles["fp-card"]}>
        ...
        {step === 1 && (
          ...
          >
            ...
            >
              {loading ? (
                <span className={styles["fp-spinner"]} />
              ) : (
                "Send Reset Code"
              )}
            </button>
        ...
        {step === 2 && (
          ...
          >
            ...
            >
              {loading ? <span className={styles["fp-spinner"]} /> : "Continue"}
            </button>
            <button
              type="button"
              className={styles["fp-back-link"]}
        ...
        {step === 3 && (
          ...
          >
            ...
            {newPassword.length > 0 && (
              <ul className={styles["fp-rules"]}>
                {ruleResults.map((r) => (
                  ...
                  >
                    <span className={styles["fp-rule-icon"]}>
                      {r.passed ? "✓" : "✗"}
                    </span>
                    {r.label}
                  </li>
            ...
            <div className={styles["fp-field"]}>
              <label className={styles["fp-label"]}>
                Confirm Password{" "}
                <span className={styles["fp-required"]}>*</span>
              </label>
              <div className={styles["fp-input-wrap"]}>
                <FaLock className={styles["fp-icon-left"]} />
                <input
              ...
              {confirmPassword && confirmPassword !== newPassword && (
                <small className={styles["fp-match-err"]}>
            ...
            <button
              ...
              type="submit"
              disabled={
                loading || !allRulesPassed || newPassword !== confirmPassword
              }
            >
              {loading ? (
                <span className={styles["fp-spinner"]} />
        ...
        {step === 4 && (
          <div className={styles["fp-success"]}>
            ...
            <button className={styles["fp-btn"]} onClick={() => navigate("/")}>
              Back to Login
            </button>
          </div>
        )}
